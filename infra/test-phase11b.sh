...
(cd backend && UV_CACHE_DIR="$root/backend/.uv-cache" uv run --frozen python -m ruff check app tests/test_monitors.py tests/test_monitor_evaluation.py tests/test_phase11a_postgres.py tests/test_phase11b_postgres.py tests/test_phase11b_elasticsearch.py migrations)
