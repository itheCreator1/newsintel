...
(cd backend && NEWSINTEL_RUN_POSTGRES_TESTS=1 NEWSINTEL_DATABASE_URL="$host_test_database" NEWSINTEL_ELASTICSEARCH_URL="$host_elasticsearch_url" NEWSINTEL_FEED_TEST_ALLOWED_HOSTS='["localhost"]' UV_CACHE_DIR="$root/backend/.uv-cache" uv run --frozen python -m pytest -q -rs tests/test_monitors.py tests/test_monitor_api.py tests/test_monitor_evaluation.py tests/test_saved_searches.py tests/test_search_results.py tests/test_monitor_model_postgres.py tests/test_monitor_evaluation_postgres.py tests/test_monitor_evaluation_elasticsearch.py tests/test_monitor_api_postgres.py tests/test_monitor_results_elasticsearch.py) > "$artifacts/pytest.log"
...
(cd backend && UV_CACHE_DIR="$root/backend/.uv-cache" uv run --frozen python -m ruff check app tests/test_monitors.py tests/test_monitor_api.py tests/test_monitor_evaluation.py tests/test_search_results.py tests/test_monitor_model_postgres.py tests/test_monitor_evaluation_postgres.py tests/test_monitor_evaluation_elasticsearch.py tests/test_monitor_api_postgres.py tests/test_monitor_results_elasticsearch.py migrations)
