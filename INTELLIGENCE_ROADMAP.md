...
- Current phase: Phase 12C — Event API (branch `phase/12c-event-api`)
- Current status: `COMPLETE`
- Next action: review Phase 12C; commit and merge into local `main` only on explicit approval (nothing is pushed). Phase 12D (event frontend) starts afterwards from `main`.
